...
#include "ccconfig.h"  // For MAXNOTES
...
// ADD THESE EXPLICIT DECLARATIONS
extern uint8_t RootNoteOffset;
extern uint8_t note_peak_freqs[MAXNOTES];
extern uint16_t note_peak_amps[MAXNOTES];
extern uint16_t note_peak_amps2[MAXNOTES];
extern uint8_t note_jumped_to[MAXNOTES];

void InitColorChord(void);
void UpdateFreqs(void);
void HandleFrameInfo(void);
...
//this guard may be wrong
#ifndef NOTERANGE  // Add guard
